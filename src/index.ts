...
export const Gray = {
  ...
  gray10: toHexCode(HUE.gray, 10),
  gray15: toHexCode(HUE.gray, 15),
  gray20: toHexCode(HUE.gray, 20),
  gray25: toHexCode(HUE.gray, 25),
  gray30: toHexCode(HUE.gray, 30),
  gray35: toHexCode(HUE.gray, 35),
  gray40: toHexCode(HUE.gray, 40),
  gray45: toHexCode(HUE.gray, 45),
  gray50: toHexCode(HUE.gray, 50),
  gray55: toHexCode(HUE.gray, 55),
  gray60: toHexCode(HUE.gray, 60),
  gray65: toHexCode(HUE.gray, 65),
  gray70: toHexCode(HUE.gray, 70),
  gray75: toHexCode(HUE.gray, 75),
  gray80: toHexCode(HUE.gray, 80),
  gray85: toHexCode(HUE.gray, 85),
  gray90: toHexCode(HUE.gray, 90),
  gray95: toHexCode(HUE.gray, 95),
  gray100: "#ffffff",
} as const;
